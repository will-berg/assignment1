...
def set_CMV():
	...
	CMV[8] = c.cond_8(d.POINTS, d.PARAMETERS.a_pts, d.PARAMETERS.b_pts, d.PARAMETERS.radius1)
	CMV[9] = c.cond_9(d.POINTS, d.PARAMETERS.c_pts, d.PARAMETERS.d_pts, d.PARAMETERS.epsilon)
